        ...
        <main className="flex-1 p-6 space-y-8 max-w-7xl">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              <h1 className="text-4xl font-bold tracking-tight">AI-Powered Influencer Search</h1>
              <Badge variant="secondary" className="bg-gradient-primary text-primary-foreground font-medium px-3 py-1">
                AI
              </Badge>
            </div>
            <p className="text-lg text-muted-foreground">Find the perfect micro influencers for your campaigns across all platforms.</p>
          </div>
            ...
            <CardContent className="space-y-6">
              ...
              {!showResults && (
                <div className="space-y-4 p-4 bg-primary/5 rounded-lg border border-primary/20">
                  <h3 className="font-medium text-primary">First, tell us about your campaign objective:</h3>
